...
#Tools Make Sadman Samir Snigdho
#update no : 1
#Mr-EHAN-Vau
#Programer Ehan-vau 
W = '\033[97;1m' 
...
\033[93;1m[-] AUTHOR    IMTIAZUR RAHMAN EHAN 
\033[93;1m[-] GITHUB     EHAN-156-PECK
\033[93;1m[-] CREATOR  Mr-EHAN   
\033[93;1m╰──────────•◈•───────────────────╯  
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system("xdg-open https://youtube.com/@swaggang5058")
			print("")
			time.sleep(2.0)
		...
		if SNIGDHO in ["1", "01"]:
			self.fbtua()
		if SNIGDHO in ["2", "02"]:
			os.system('xdg-open https://www.facebook.com/unexpected.brocan.203?mibextid=ZbWKwL')
		if SNIGDHO in ["3", "03"]:
			os.system('xdg-open https://youtube.com/@swaggang5058')
		if SNIGDHO in ["4", "04"]:
			os.system('xdg-open https://github.com/EHAN-156-PECK')
		if SNIGDHO in ["0", "00"]:
			self.old2()
			exit()
		else:
